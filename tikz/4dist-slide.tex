...
\begin{scope}[xshift=-4.75cm]
    ...
    % Light gray lines
    \draw[cyan, ultra thick, dotted] (-1,0.7)  -- (-0.3,0) -- (-1,-0.7);
    \draw[cyan, ultra thick, dotted] (2.5,0.7) -- (1.8,0)  -- (2.5,-0.7);
    % Nodes labels
...
\begin{scope}
  % Black lines
    ...
    \draw[black, very thick] (2.5,1) -- (1.5,0) -- (2.5,-1);
    % Light gray lines
    \draw[cyan, ultra thick, dotted] (-0.7,1)  -- (0.1,0.2)  -- (1.4,0.2)  -- (2.2,1);
    \draw[cyan, ultra thick, dotted] (-0.7,-1) -- (0.1,-0.2) -- (1.4,-0.2) -- (2.2,-1);
    % Nodes labels
    \node[left]   at (-1,1.1)    {$\LT$};
    \node[left]   at (-1,-1.1)   {$\LB$};
...
\begin{scope}[xshift=4.75cm]
    ...
    \draw[black, very thick] (2.5,1) -- (1.5,0) -- (2.5,-1);
    % Light gray lines
    \draw[cyan, ultra thick, dotted] (-0.7,1)  -- (0.5,-0.2) -- (1.4,-0.2) -- (2.2,-1);
    \draw[cyan, ultra thick, dotted] (-0.7,-1) -- (0.5,0.2)  -- (1.4,0.2)  -- (2.2,1);
    % Nodes labels
    \node[left]   at (-1,1.1)    {$\LT$};
    \node[left]   at (-1,-1.1)   {$\LB$};
